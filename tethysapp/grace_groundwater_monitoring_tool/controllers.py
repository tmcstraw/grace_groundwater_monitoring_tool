...
def home(request):
    ...
    Session = GraceGroundwaterMonitoringTool.get_persistent_store_database('grace_db',as_sessionmaker=True)
    session = Session()
    ...
    return render(request, 'grace_groundwater_monitoring_tool/home.html', context)
...
def global_map(request):
    ...
    return render(request, 'grace_groundwater_monitoring_tool/global_map.html', context)
...
def region(request):
    ...
    return render(request, 'grace_groundwater_monitoring_tool/region.html', context)
...
def add_region(request):
    ...
    return render(request, 'grace_groundwater_monitoring_tool/add_region.html', context)
...
def add_thredds_server(request):
    ...
    return render(request, 'grace_groundwater_monitoring_tool/add_thredds_server.html', context)
...
def manage_regions(request):
    ...
    return render(request, 'grace_groundwater_monitoring_tool/manage_regions.html', context)
...
def manage_regions_table(request):
    ...
    return render(request, 'grace_groundwater_monitoring_tool/manage_regions_table.html', context)
...
def manage_thredds_servers(request):
    ...
    return render(request, 'grace_groundwater_monitoring_tool/manage_thredds_servers.html', context)
...
def manage_thredds_servers_table(request):
    ...
    return render(request, 'grace_groundwater_monitoring_tool/manage_thredds_servers_table.html', context)
...
def update_global_files(request):
    ...
    return render(request, 'grace_groundwater_monitoring_tool/update_global_files.html', context)
